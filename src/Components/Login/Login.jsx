...
import FormGoFb from "./Subcomponents/FormGoFb/FormGoFb";
                        ...
                        !isLoading &&
                            <>
                                ...
                                <Content item xs={12} >
                                    ...
                                    />
                                    {/* Botones de logeo GOOGLE & FACEBOOK  */}                                            
                                    <FormGoFb                                        
                                        loginWithGoogle={ (name, email, password, avatar ) => this.loginWithGoogle(name, email, password, avatar)}                                                                               
                                    /> 
                                </Content>
