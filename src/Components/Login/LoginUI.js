...
class LoginUI extends Component {
	...
	/**
	 * @desc Ingresar con google
	 * 
	 * @param { String } uri
	 * 
	 * @return { Boolean }
	 */
	loginWithGoogle = async ( name, email, password, avatar = null ) => {

		try {
			
			const response = await LoginModel.LoginWithGoogle( {name, email, password, avatar } );

			// Verificamos el error
			if( response instanceof TypeError ){
				this.loginWithGoogleFail( response );
			}
			...
			if( response.status === 200 ){
				...
				// Logueo exitoso.
				this.loginWithGoogleSuccess( response );
	...
	/**
	 * @desc Error al Ingresar con google.
	 * 
	 * @param { Object } response
	 * 
	 * @return { Boolean }
	 */
	loginWithGoogleFail( response ){
	...
	/**
	 * @desc Ingresar con google con exito.
	 * 
	 * @param { Object } response
	 * 
	 * @return { Boolean }
	 */
	loginWithGoogleSuccess( response ){
